...
import bsu.rfe.java.group6.lab3.tuz.var19.GornerTableCellRenderer;
import bsu.rfe.java.group6.lab3.tuz.var19.GornerTableModel;
    ...
    public MainFrame(Double[] coefficients) {
        ...
        Action aboutInfoAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {
                JOptionPane.showMessageDialog(MainFrame.this, "Туз Андрей, 6 группа", "О программе",
